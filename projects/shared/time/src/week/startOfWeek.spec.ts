...
const testCases = [
  {
    ...
    expected: zonedDateTime("2024-09-02T00:00:00[Europe/Berlin]"),
  },
  {
    description: "should handle Friday in America/New_York timezone",
    dateTime: zonedDateTime("2024-09-06T15:30:00[America/New_York]"),
    expected: zonedDateTime("2024-09-02T00:00:00[America/New_York]"),
  },
  {
    description: "should handle Monday (start of week) in Europe/Berlin timezone",
    dateTime: zonedDateTime("2024-09-02T12:00:00[Europe/Berlin]"),
    expected: zonedDateTime("2024-09-02T00:00:00[Europe/Berlin]"),
  },
  {
    description: "should handle Sunday (end of week) in Europe/Berlin timezone",
    dateTime: zonedDateTime("2024-09-08T23:59:59[Europe/Berlin]"),
    expected: zonedDateTime("2024-09-02T00:00:00[Europe/Berlin]"),
  },
  {
    ...
    expected: zonedDateTime("2024-02-26T00:00:00[Europe/Berlin]"),
  },
  {
    description: "should handle New Year's Day in America/New_York timezone",
    dateTime: zonedDateTime("2024-01-01T10:00:00[America/New_York]"),
    expected: zonedDateTime("2024-01-01T00:00:00[America/New_York]"),
  },
] as const;

it.each(testCases)("$description", (testCase) => {
  const result = startOfWeek(testCase.dateTime)
